...
# ✅ PyMuPDF (Render fix: add PyMuPDF to requirements.txt)
import fitz  # PyMuPDF
...
def chat():
    ...
    msg_raw = msg.strip().lower()  # raw for commands
    ...
    # ✅ If quiz is active, accept ONLY 1-4 answers
